    ...
    void keyboard(int key, int action){
        ...
        if (action == GLFW_PRESS) {
            switch (key) {
                case 83:
                {
                    translation_ *= Eigen::Affine3f(Eigen::Translation3f(0.0f, 0.1f, 0.0f)).matrix();
                ...
                case GLFW_KEY_UP:
                {
                    translation_ *= Eigen::Affine3f(Eigen::Translation3f(0.0f, 0.0f, 0.1f)).matrix();
                    view_matrices_changed = true;
                } break;
                case GLFW_KEY_DOWN:
                {
                ...
                case GLFW_KEY_LEFT:
                {
                    translation_ *= Eigen::Affine3f(Eigen::Translation3f(0.1f, 0.0f, 0.0f)).matrix();
                    view_matrices_changed = true;
                } break;
                case GLFW_KEY_RIGHT:
                {
